...
import { Client, Project, DailyProgress, Version, Feature, DailyMemory, CompanyStats } from '../models';
...
export class DatabaseService {
  ...
  async addDailyProgress(progress: Omit<DailyProgress, 'id' | 'created_at'>): Promise<DailyProgress> {
  ...
  async createVersion(version: Omit<Version, 'id' | 'created_at'>): Promise<Version> {
  ...
  async createFeature(feature: Omit<Feature, 'id' | 'created_at'>): Promise<Feature> {
  ...
  async createDailyMemory(memory: Omit<DailyMemory, 'id' | 'created_at' | 'updated_at'>): Promise<DailyMemory> {
