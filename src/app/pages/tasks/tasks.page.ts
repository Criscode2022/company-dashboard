...
import { Task, Tag, Priority, TaskStatus } from '../../models/task.model';
import { addIcons } from 'ionicons';
import { 
  add, funnel, checkmarkCircle, ellipse, calendar, flag,
  search, filter, trash, create, chevronDown
} from 'ionicons/icons';
...
@Component({
  ...
  styles: [`
    ...
    .task-checkbox input { width: 100%; height: 100%; cursor: pointer; }
...
export class TasksPage implements OnInit {
  ...
  constructor(private taskService: TaskService) {
    addIcons({ add, funnel, checkmarkCircle, ellipse, calendar, flag, search, filter, trash, create, chevronDown });
  }
