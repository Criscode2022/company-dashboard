...
import { DEFAULT_TAG_COLORS, Tag } from "../../models/task.model";
      ...
      <div *ngIf="showAddTag" class="card mb-4">
        <div class="card-body">
          ...
          <div class="form-actions">
            <button class="btn btn-secondary" (click)="showAddTag = false">
              Cancel
            </button>
            <button
      ...
      <div class="tags-grid">
        ...
        >
          ...
          <div class="tag-actions">
            <button class="btn btn-ghost btn-sm" (click)="deleteTag(tag.id)">
              🗑️ Delete
            </button>
          </div>
        </div>
