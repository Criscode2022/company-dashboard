        ...
        <ion-card-content>
          <ion-list>
            <ion-item *ngFor="let stat of stats.slice(-7)">
              ...
              <ion-note slot="end">
                {{stat.total_commits}} commits &#183; {{stat.total_features}} features
              </ion-note>
            </ion-item>
          </ion-list>
        </ion-card-content>
        ...
        <ion-card-content>
          <ion-list>
            <ion-item>
              ...
              <ion-badge color="medium" slot="end">{{projectStatusCounts.discovery}}</ion-badge>
            </ion-item>
            <ion-item>
              <ion-label>In Progress</ion-label>
              <ion-badge color="warning" slot="end">{{projectStatusCounts.in_progress}}</ion-badge>
            </ion-item>
            <ion-item>
              <ion-label>Beta</ion-label>
              <ion-badge color="tertiary" slot="end">{{projectStatusCounts.beta}}</ion-badge>
            </ion-item>
            <ion-item>
              <ion-label>Production</ion-label>
              <ion-badge color="success" slot="end">{{projectStatusCounts.production}}</ion-badge>
            </ion-item>
            <ion-item>
              <ion-label>Maintenance</ion-label>
              <ion-badge color="primary" slot="end">{{projectStatusCounts.maintenance}}</ion-badge>
            </ion-item>
          </ion-list>
        </ion-card-content>
      </ion-card>
